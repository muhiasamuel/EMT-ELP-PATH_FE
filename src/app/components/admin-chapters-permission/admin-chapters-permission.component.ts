...
const permissionMappings: { [key: string]: string[] } = {
  edit: ['CHAPTER_UPDATE'],
  add: ['CHAPTER_ADD'],
  view: ['CHAPTER_VIEW', 'CHAPTER_MEMBERS_VIEW', 'CHAPTER_VIEW_ALL'],
  delete: ['CHAPTER_DELETE'],
};
@Component({
  selector: 'app-admin-chapters-permission',
  templateUrl: './admin-chapters-permission.component.html',
  styleUrls: ['./admin-chapters-permission.component.scss'],
})
export class AdminChaptersPermissionComponent {
