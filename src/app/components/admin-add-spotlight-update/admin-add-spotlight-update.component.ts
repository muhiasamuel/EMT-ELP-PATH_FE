...
@Component({
  selector: 'app-admin-add-spotlight-update',
  templateUrl: './admin-add-spotlight-update.component.html',
  styleUrls: ['./admin-add-spotlight-update.component.scss']
})
export class AdminAddSpotlightUpdateComponent implements OnInit{

  newsForm: FormGroup;
  previewImage: string | undefined;
  constructor(
    private dialogRef: MatDialogRef<AdminAddSpotlightUpdateComponent>,
