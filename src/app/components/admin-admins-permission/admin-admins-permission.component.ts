...
@Component({
  selector: 'app-admin-admins-permission',
  templateUrl: './admin-admins-permission.component.html',
  styleUrls: ['./admin-admins-permission.component.scss'],
})
export class AdminAdminsPermissionComponent {
